...
=begin
# seeing if I can move this logic into MPDAbstract module
# this is causing mpd max_connections to be reached for some reason (i.e. I'm only connected if we're not already connected so not sure whats up)
